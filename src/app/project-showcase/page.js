                    ...
                    <div className="lg:col-span-1 space-y-12">
                        <div className="bg-slate-800/60 backdrop-blur-xl p-8 rounded-2xl border border-purple-700/50 shadow-2xl sticky top-12 transition-all duration-300 hover:-translate-y-2 hover:shadow-purple-500/20">
                            <div className="flex items-center mb-8">
                                ...
                                <h2 className="text-3xl font-bold text-purple-300">Poster Presentation</h2>
                            </div>

                            <p class="text-gray-300 mb-8 text-lg">Showcase powerful ideas on **AI-powered learning** through a creative poster at Bangladesh’s biggest data science event!</p>
